import AbstractApiGenerator from '../openapi.js';
import { isPaginationEnabled } from '../helpers.js';
...
class OpenApiV2Generator extends AbstractApiGenerator {
  ...
  getOperationDefaults() {
    return {
      ...
      custom(
        { tags, modelName, idName, idType, security, securities, specs, refs },
...
export default OpenApiV2Generator;
